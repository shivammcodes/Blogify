...
const page = () => {
  ...
  return (
    <div className="wrapper w-full min-h-screen relative pb-32 sm:pb-40 lg:pb-44 pt-20 sm:pt-24 lg:pt-28 xl:pt-36 px-4 sm:px-6 md:px-10 lg:px-16 xl:px-36 font-sans">

      {/* HEADER */}
      <div className="blog-header mt-16 sm:mt-20 lg:mt-24 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5 mb-10 sm:mb-14 lg:mb-16">
      ...
      {search.length > 0 ? (
        ...
        <div className="wrapper w-full">
          ...
          {foundBlog?.map((value) => (
            ...
            <div
              className="blog grid grid-cols-1 lg:grid-cols-5 h-fit gap-5 lg:gap-x-12 xl:gap-x-20 my-8 sm:my-12 lg:my-16"
              key={value._id}
            >
              ...
              <div className="right col-span-1 lg:col-span-3 bg-secondary px-4 sm:px-5 py-4 rounded-xl">
        ...
        <>
          ...
          <div className="sec-2 grid grid-cols-1 lg:grid-cols-6 gap-10 lg:gap-x-6 w-full h-fit">
            ...
            <div className="left col-span-1 lg:col-span-4">
              ...
              <div className="date text-sm sm:text-lg text-gray-900/60">
                ...
                {firstSectionLeft && (
                  format(
                    new Date(firstSectionLeft.createdAt),
                    "PPP"
                  )
                )}
                ...
                <div className="up" key={value._id}>
                  ...
                  <div className="img h-fit w-full rounded-2xl">
                    ...
                    <Image
                      ...
                      width={1200}
                      height={800}
                      className="h-48 sm:h-52 lg:h-40 object-cover w-full rounded-2xl"
                    />
          ...
          <div className="blogs relative grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-x-10 lg:gap-x-16 gap-y-10 mt-14 sm:mt-16 lg:mt-20">

            {secondSection?.map((value) => (

              <div
                className="wrapper col-span-1 h-fit rounded-xl"
                key={value._id}
              >
                ...
                <Image
                  src={value.coverImage}
                  alt=""
                  className="h-56 sm:h-64 md:h-72 lg:max-h-80 w-full rounded-xl object-cover"
                  height={800}
                  width={1200}
                />
          ...
          <div className="wrapper grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mt-14 sm:mt-16 lg:mt-20 gap-8 lg:gap-14">

            {thirdSection?.map((value) => (

              <div
                className="box col-span-1 w-full h-fit"
                key={value._id}
              >
            ...
            {blogDisplayCount < (posts?.length ?? 0) && (
              ...
              <Button
                ...
                onClick={() => {
                  setBlogDisplayCount(blogDisplayCount + 6);
                }}
                variant={"secondary"}
              >
                Load More
