  ...
  return (
    <div className="wrapper w-full min-h-screen relative pb-56 pt-32 sm:pt-40 lg:pt-44 px-5 sm:px-8 md:px-12 lg:pl-36 lg:pr-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-10 lg:gap-x-16 items-start">
        ...
        <div className="left lg:col-span-3 min-w-0">
        ...
        <div className="right lg:col-span-1 lg:sticky lg:top-36 h-fit">

          {/* Tags */}

          <div className="tags">

            <div className="title mb-4 text-xl font-display">
              All Tags
            </div>
          ...
          <div className="posts w-full bg-secondary py-4 px-3 mt-5 rounded-xl">
            ...
            {extraPosts?.map(value => (
              ...
              <Link
                href={`/blogs/${value._id}`}
                key={value.title}
              >

                <div className="post w-full grid grid-cols-4 gap-x-2 h-fit my-7">

                  <div className="left col-span-1 w-full h-12 rounded-lg overflow-hidden">
            ...
            <div className="content w-full h-full overflow-y-auto p-5 sm:p-8 md:p-10">
              ...
              {!summary && keyPoints.length === 0 && !takeaway ? (
                ...
                <div className="flex min-h-full flex-col items-center justify-center text-center">
                  ...
                  <p className="mt-2 max-w-md text-sm text-muted-foreground font-inter">
                ...
                <div className="mx-auto max-w-3xl pb-10">
                  ...
                  <div className="rounded-2xl border bg-background p-5 sm:p-6 shadow-sm">
                    ...
                    <p className="text-[15px] leading-7 text-muted-foreground font-inter">
                      {summary}
                    </p>
                  ...
                  ">
                    ...
                    <p className="text-base leading-7 font-inter">
                      {takeaway}
                    </p>
